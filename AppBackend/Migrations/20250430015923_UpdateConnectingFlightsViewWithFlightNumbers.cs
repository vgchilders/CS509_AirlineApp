...
{
    /// <inheritdoc />
    public partial class UpdateConnectingFlightsViewWithFlightNumbers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
           ...
           migrationBuilder.Sql(@"
            ...
            SELECT
                ...
                f1.FlightNumber AS Flight1Number,
                f2.FlightNumber AS Flight2Number,
                ...
                TIMEDIFF(f1.ArriveDateTime, f1.DepartDateTime) AS Flight1Duration,
                TIMEDIFF(f2.ArriveDateTime, f2.DepartDateTime) AS Flight2Duration,
